...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_params):
  ...
  Convenience layer that performs:
    affine transform --> batch norm --> ReLU
...
def affine_bn_relu_backward(dout, cache):
  ...
  dbn_in = relu_backward(dout, relu_cache)

  # Add the batch backward
  da, dgamma, dbeta = batchnorm_backward(dbn_in, bn_cache)
...
def conv_bn_relu_forward(x, w, b, gamma, beta, conv_param, bn_param):
  """
  Convenience layer that performs a convolution, a batch norm and a ReLU.

  Inputs:
  - x: Input to the convolutional layer
  - w, b, conv_param: Weights and parameters for the convolutional layer
  - gamma, beta, bn_params: parameters for batch norm
