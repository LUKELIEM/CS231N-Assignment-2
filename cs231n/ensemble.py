...
class Ensemble(object):
  ...
  The ensemble accepts test and validation data and use the ensembled models
  to generate scores and check accuracy.
  ...
  model1 = MyAwesomeModel1(hidden_size=100, reg=10)
  model2 = MyAwesomeModel2(hidden_size=200, reg=10)
  
  ensemble = Ensemble()
  ensemble.add(model1, 'params1.npz')
  ensemble.add(model2, 'params2.npz')
